...
def loadCam(args, id, cam_info, resolution_scale, is_nerf_synthetic, is_test_dataset):
    if args.resolution > 1:
        ...
        image_path = load_path if not need_resize else cam_info.image_path
    else:
        image_path, need_resize = cam_info.image_path, True
    ...
    return Camera(need_resize, resolution, colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, 
