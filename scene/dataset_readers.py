...
def readColmapSceneInfo(path, images, depths, eval, train_test_exp, llffhold=8):
    ...
    # test_keyword = "extra"
    # train_cam_infos = [c for c in cam_infos if train_keyword in c.image_name]
    # test_cam_infos = [c for c in cam_infos if test_keyword in c.image_name]
    # if not train_cam_infos or not test_cam_infos:
